...
var displayMap = function displayMap(locations) {
  ...
  var createPopup = function createPopup(options) {
    new mapboxgl.Popup({
      offset: 30,
      closeOnClick: false
    }).setLngLat(options.coordinates).setHTML("<p class='popup-".concat(options.day, "'>Day ").concat(options.day, " ").concat(options.description, "</p>")).addTo(map);
  };
  locations.forEach(function (location) {
    ...
    element.addEventListener('click', function () {
      if (document.querySelector(".popup-".concat(location.day))) return;
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe('pk_test_51MVfI4FXr2koWylriEG8sStwOuvADLGu5K6gIAl4H5sE7ZuyxkB4zyElQRRYAckQZjWaCl0ByZ2DLA6mxqvqk1P200fpeeYHZR');
...
var getInputsForm = function getInputsForm(form) {
  var dataArr = _toConsumableArray(new FormData(form));
  console.log(dataArr);
  var data = Object.fromEntries(dataArr);
  return data;
};
var removeInputsForm = function removeInputsForm(form) {
